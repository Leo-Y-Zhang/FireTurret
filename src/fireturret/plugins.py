...
network calls at module scope, and `fireturret --list-plugins` should not be able to
...
GROUP_RIG = "fireturret.rig.v0"
GROUP_PROFILE = "fireturret.profile.v0"
GROUP_DETECTOR = "fireturret.detector.v0"
