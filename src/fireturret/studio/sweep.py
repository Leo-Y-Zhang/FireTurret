...
def with_field(config: FireTurretConfig, scenario: SimScenario, group: str, name: str, value):
...
def sweep_grid(base_config: FireTurretConfig, base_scenario: SimScenario,
