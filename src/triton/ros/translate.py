...
# The tf2 frame names, matching triton.frames' chain so the two cannot drift.
FRAME_WORLD = "triton/world"
FRAME_PLATFORM = "triton/platform"
FRAME_PAN = "triton/pan"
FRAME_TILT = "triton/tilt"
FRAME_CAMERA = "triton/camera"
